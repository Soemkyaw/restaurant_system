<x-dashboard-layout>
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
        <div class="container px-6 py-8 mx-auto">
            <h3 class="text-2xl font-medium text-gray-700">Edit Menu</h3>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="col-span-full">
                                        <label for="image"
                                            ...
                                            Image</label>
                                        <div>
                                            <img src="{{ asset('storage/'.$menu->image) }}" class="h-28 bg-clip-content border-2 border-gray-500 border-dashed">
                                        </div>
                                        <div
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="name" id="name"
                                                value="{{ old('name',$menu->name) }}" autocomplete="given-name"
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <input id="price" name="price" type="number" autocomplete="price"
                                                placeholder="Enter price" value="{{ old('price',$menu->price) }}"
                                                class="block w-full rounded-md border-0 py-3 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                            <x-error name="price" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="mt-2">
                                            <select id="category_id" name="category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option {{ $menu->category_id == $category->id ? "selected" : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-4 flex space-x-4">
                                            <div class="flex items-center">
                                                <input type="radio" id="availableYes" name="is_available"
                                            ...
                                            <div class="flex items-center">
                                                <input type="radio" id="availableNo" name="is_available"
                                                    value="0" {{ !$menu->is_available ? "checked" : '' }}
                                                    class="h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-600">
                                    ...
                                    <div class="sm:col-span-2">
                                        ...
                                        <div class="mt-2">
                                            <input type="number" name="preparation_time" id="preparation_time"
                                                placeholder="Enter preparation time" autocomplete="preparation_time"
                                    ...
                                    <div class="sm:col-span-3">
                                        <label for="spicy_level"
                                            ...
                                            Level</label>
                                        <div class="mt-2">
                                            <input type="number" name="spicy_level" id="spicy_level" value="{{ old('spicy_level',$menu->spicy_level) }}"
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                            <input type="number" name="discount" value="{{ old('discount',$menu->discount) }}" id="discount"
