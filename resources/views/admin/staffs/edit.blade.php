<x-dashboard-layout>
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
        <div class="container px-6 py-8 mx-auto">
            <h3 class="text-2xl font-medium text-gray-700">Edit Staff</h3>

            <div class="flex flex-col min-h-screen mt-4">
                <div class=" bg-white shadow-lg rounded-lg p-6 w-full">

                    <form action="{{ route('staff.update',$user->slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2 flex items-center gap-x-3">
                                            ...
                                            <img src="{{ asset('storage/'.$user->avatar) }}" class=" rounded-full" style="width: 100px;height: 100px" alt="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <input type="number" name="phone_no" id="phone_no" placeholder="Enter Phone No"
                                                autocomplete="phone_no"  value="{{ old('phone_no',$user->phone_no) }}"
                                                class="block w-full rounded-md border-0 py-3 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <input type="text" name="address" id="address" placeholder="Enter Address"
                                                autocomplete="address"  value="{{ old('address',$user->address) }}"
                                                class="block w-full rounded-md border-0 py-3 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        </div>
                                    </div>
                                    <div class="sm:col-span-3">
