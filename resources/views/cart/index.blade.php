            ...
            <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                <div class="rounded-lg md:w-2/3">
                    @foreach ($carts as $cart)
                        <div class="cart-{{ $cart->id }} justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                            <img src="{{ asset('storage/'.$cart->menuItem->image) }}"
                            ...
                            <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                <div class="mt-5 sm:mt-0">
                                    ...
                                    <p class="mt-1 text-xs text-gray-700">{{ number_format($cart->menuItem->price) }} Ks</p>
                                </div>
                                <div class="qtyHandler mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 ">
                                    ...
                                    <div class="flex items-center border-gray-100 ">
                                        <button
                                            ...
                                            + </button>
                                        <input class="h-8 w-8 border bg-white text-center text-xs outline-none recpie-qty" min="1"
                                        type="number" value="{{ (int)$cart->quantity }}" />
                                        <button
                ...
                <div class="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div class="">
                            <p class="mb-1 text-lg font-bold">??? USD</p>
