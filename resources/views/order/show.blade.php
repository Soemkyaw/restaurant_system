<x-dashboard-layout>
    ...
    <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
        <tr>
            ...
            <th class="p-2 whitespace-nowrap">
                <div class="font-semibold text-center">Status</div> <!-- Fixed typo here -->
            </th>
        </tr>
    </thead>
    <tbody class="text-sm divide-y divide-gray-100">
        ...
        <tr>
            <td class="p-2 whitespace-nowrap">
                <a href="{{ route('order.show', $item->id) }}" class="text-center text-blue-500 block">{{ $item->order_id }}</a>
            </td>
            <td class="p-2 whitespace-nowrap">
                <div class="flex justify-center">
                    <img src="{{ asset('storage/' . $item->menuItem->image) }}" class="w-28 h-20 rounded-xl">
                </div>
            </td>
            <td class="p-2 whitespace-nowrap">
                <div class="text-left">{{ $item->menuItem->name }}</div>
            ...
            <td class="p-2 whitespace-nowrap">
                <div class="text-center font-medium">{{ $item->quantity }}</div> <!-- Fixed alignment -->
            </td>
            <td class="p-2 whitespace-nowrap">
